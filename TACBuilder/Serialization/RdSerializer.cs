                     ...
                     .Select((v, i) => (i, v)))
        {
            ...
            IlTypeDto dto = type switch
            {
                IlPointerType pointerType => new IlPointerTypeDto(
                    ...
                    isInterface: pointerType.IsInterface,
                    isAbstract: pointerType.IsAbstract,
                    ...
                    genericParameterConstraints: pointerType.GenericParameterConstraints.Select(KeyBuilder.GetTypeId).ToList(),
                ...
                IlStructType structType => new IlStructTypeDto(
                    ...
                    isInterface: structType.IsInterface,
                    isAbstract: structType.IsAbstract,
                    ...
                    genericParameterConstraints: structType.GenericParameterConstraints.Select(KeyBuilder.GetTypeId).ToList(),
                ...
                IlEnumType enumType => new IlEnumTypeDto(
                    ...
                    isInterface: enumType.IsInterface,
                    isAbstract: enumType.IsAbstract,
                    ...
                    genericParameterConstraints: enumType.GenericParameterConstraints.Select(KeyBuilder.GetTypeId).ToList(),
                ...
                IlPrimitiveType primitiveType => new IlPrimitiveTypeDto(
                    ...
                    isInterface: primitiveType.IsInterface,
                    isAbstract: primitiveType.IsAbstract,
                    ...
                    genericParameterConstraints: primitiveType.GenericParameterConstraints.Select(KeyBuilder.GetTypeId).ToList(),
                ...
                IlClassType classType => new IlClassTypeDto(
                    ...
                    genericParameterConstraints: classType.GenericParameterConstraints.Select(KeyBuilder.GetTypeId).ToList(),
                ...
                IlArrayType arrayType => new IlArrayTypeDto(
                    ...
                    isInterface: arrayType.IsInterface,
                    isAbstract: arrayType.IsAbstract,
                    ...
                    genericParameterConstraints: arrayType.GenericParameterConstraints.Select(KeyBuilder.GetTypeId).ToList(),
