...
namespace IntegrationTests
{
    ...
    internal class ClassesSimpleHierarchyA1 : ClassesSimpleHierarchyA
    {
        ...
        public ClassesSimpleHierarchyA1(int i) : base(
            ClassesSimpleRegistrator.RegisterAndReturn("ARG ClassesSimpleHierarchyA1(int i) : base I", i - 1))
        {
    ...
    internal class ClassesSimpleHierarchyA2 : ClassesSimpleHierarchyA1
    {
        ...
        public ClassesSimpleHierarchyA2(int i) : base(
            ClassesSimpleRegistrator.RegisterAndReturn("ARG ClassesSimpleHierarchyA2(int i) : base I", i - 1))
        {
            num2 = ClassesSimpleRegistrator.RegisterAndReturn("ClassesSimpleHierarchyA2(int i) I", num1 + 1);
        }

        public ClassesSimpleHierarchyA2(int i, int j) : this(
            ClassesSimpleRegistrator.RegisterAndReturn("ARG ClassesSimpleHierarchyA2(int i, int j) : this I", i))
        {
    ...
    public class ClassesSimplePropertyAccessModify
    {
        ...
        public SimpleContainer ContainerProperty { get; set; }


        public int TestProperty1(int anyVarName)
        {
            return (new ClassesSimplePropertyAccessModify().ContainerProperty = new SimpleContainer()).X =
                anyVarName; // anyVarName
        }
